...
const CustomFormSelect: React.FC<CustomFormSelectProps> = ({
  ...
  const customStyles = {
    control: (provided: any) => ({
      ...provided,
      borderColor: error ? AppColor.dangerError : AppColor.selectBorderColor,
      "&:hover": {
        borderColor: error ? AppColor.dangerError : AppColor.selectBorderColor,
      },
      boxShadow: "none",
    ...
    option: (provided: any, state: any) => ({
      ...provided,
      backgroundColor: state.isSelected ? AppColor.selectBorderColor : state.isFocused ? AppColor.selectSelectionColor : "",
      color: state.isSelected ? AppColor.white : state.isFocused ? AppColor.white : AppColor.selectTextColor,
      "&:hover": {
        backgroundColor: AppColor.selectSelectionColor,
        color: AppColor.white,
      },
    }),
    singleValue: (provided: any) => ({
      ...provided,
      color: AppColor.selectTextColor,
    }),
