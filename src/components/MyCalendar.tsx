...
const MyCalendar: React.FC = () => {
  ...
  const clearCalendarFilters = () => {
    setSearchKeyword("");
    setStatusFilter("All");
    setValue("calendar_filter_status", "All", { shouldValidate: false });
    ...
    <div ref={calendarWrapperRef}>
        ...
        <CustomUtilityBox
          ...
          controlSlot={
            <div style={{ minWidth: "11rem" }}>
              <CustomFormSelect
                label="Status"
                controlId="calendar_filter_status"
                options={[
                  { value: "All", label: "All" },
                ...
                register={register}
                fieldName="calendar_filter_status"
                asCol={false}
                selectWidth="11rem"
                noBottomMargin
      ...
      <Modal show={showModal} onHide={() => setShowModal(false)}>
        ...
        <Modal.Body>
          ...
          <div className="row g-2">
            <div className="col-md-12">
              <Form.Label className="fw-medium mb-1">Order ID</Form.Label>
              <CustomFormSelect
                label=""
          ...
          <div className="row g-2">
            ...
            <div className="col-md-6">
              <CustomFormSelect
                label="Status"
                controlId="calendar_modal_status"
                options={[
                  { value: "Scheduled", label: "Scheduled" },
                  { value: "In progress", label: "In progress" },
                  { value: "Completed", label: "Completed" },
                ...
                register={register}
                fieldName="calendar_modal_status"
                asCol={false}
                defaultValue={status}
                setValue={setValue}
                onChange={(e) =>
                  setStatus(e.target.value as CalendarEvent["status"])
                }
                menuPortal
