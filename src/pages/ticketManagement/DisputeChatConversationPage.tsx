...
const DisputeChatConversationPage = () => {
  ...
  const isTicketClosed = ticketDetails
    ? Number(ticketDetails.status) !== 1 ||
      Number(ticketDetails.resolve_status) === 2
    : false;
        ...
        <div className="col-lg-8">
          <div className="border rounded-3 bg-white">
            <div className="normal-chat-message-area" ref={messageAreaRef}>
              {ticketStartedAt && (
                <div className="normal-chat-center-status text-center">
              ...
              {isTicketClosed && ticketClosedAt && (
                <div className="normal-chat-center-status text-center normal-chat-center-status-closed">
            ...
            <div className="d-flex align-items-center gap-2 p-3 border-top">
              ...
              <input
                ...
                placeholder={
                  isTicketClosed ? "Chat is closed" : "Type a message..."
                }
                value={messageDraft}
          ...
          <div className="border rounded-3 bg-white p-3">
            ...
            <div className="mb-3 small">
              ...
              <div className="fw-semibold">
                ...
                {(ticketDetails?.transferHistory ?? []).length === 0
                  ? ticketDetails?.resolved_by_name ?? "Assigned Employee"
                  : ticketDetails?.currentEmployeeName ??
                    ticketDetails?.resolved_by_name ??
                    "Assigned Employee"}
              </div>
            </div>
