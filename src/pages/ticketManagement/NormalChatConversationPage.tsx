...
const getGeneralSenderProfile = (
  sender: NormalChatMessageSender,
  userName: string,
  employeeName: string
) => {
  const isEmployee = sender === "employee";
  const name = isEmployee ? employeeName : userName;
  return {
...
const NormalChatConversationPage = () => {
  ...
  const selectedChat =
    normalChatConversations.find((chat) => chat.id === chatId) ||
    normalChatConversations[0];
      ...
      <div className="d-flex justify-content-between align-items-center mb-3">
        <div className="d-flex align-items-center gap-2">
          ...
          <h4 className="m-0 p-0">
            {isOrderThread ? "Order Chat" : "General Chat"}
          </h4>
        </div>
        <button
          type="button"
            ...
            {isOrderThread && (
              <div className="d-flex align-items-center justify-content-between p-3 border-bottom">
                <div className="d-flex align-items-center gap-2">
                  ...
                  <div>
                    <h6 className="normal-chat-user-name mb-0">{`Order · ${selectedChat.userId}`}</h6>
                    <small className="normal-chat-time">{`${selectedChat.userName} · Group chat`}</small>
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="normal-chat-message-area" ref={messageAreaRef}>
              {messages.map((msg) => {
                ...
                if (isOrderThread && participants) {
                  ...
                  const senderProfile = getOrderSenderProfile(
                    msg.sender,
                    participants
                  );
                  return (
                ...
                const senderProfile = getGeneralSenderProfile(
                  msg.sender,
                  detail.user.name,
