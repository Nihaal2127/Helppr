...
const EditOrderPaymentDialog: React.FC<EditOrderPaymentDialogProps> & {
    ...
    // Backend expects `payment_mode_id` values that match existing usage in CreateUpdateOrderDialog.
    // UI label: "Online" is shown as "RazorPay".
                ...
                <form noValidate name="edit-order-payment-form" id="edit-order-payment-form" onSubmit={handleSubmit(onSubmitEvent)}>
                    ...
                    <Row className="mt-4">
                        ...
                        <Col xs={6} className="text-center" onClick={onClose}>
                            <Button className="custom-btn-secondary">Cancel</Button>
                        </Col>
                    </Row>
                </form>
            </Modal.Body>
