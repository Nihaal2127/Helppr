  ...
  const columns = React.useMemo(
    () => [
      ...
      },
      {
        Header: "Offer ID",
        accessor: "offerId",
        Cell: textUnderlineCell("offerId", (row) =>
          openFormWithData(row, true)
        ),
      },
            ...
            <div className="row gx-3 gy-2">
              ...
              <div className="col-md-6">
                <CustomFormSelect
                  ...
                  onChange={(e) =>
                    setForm((p) => ({
                      ...p,
                      offerType: e.target.value as "percentage" | "fixed",
                    }))
                  }
                />
              </div>
              <div className="col-md-6">
                <CustomFormInput
                  ...
                  onChange={(value: string) =>
                    setForm((p) => ({ ...p, totalOfferValue: value }))
                  }
                />
              </div>
              <div className="col-md-6">
                <CustomFormInput
                  ...
                  onChange={(value: string) =>
                    setForm((p) => ({ ...p, adminContribution: value }))
                  }
                />
              </div>
              <div className="col-md-6">
                <CustomFormInput
                  ...
                  onChange={(value: string) =>
                    setForm((p) => ({ ...p, partnerContribution: value }))
                  }
                />
              </div>
              <div className="col-md-6">
              ...
              <div className="col-md-6">
                <CustomFormSelect
                  ...
                  onChange={(e) =>
                    setForm((p) => ({
                      ...p,
                      applicableOn: e.target.value as "quotes" | "orders",
                    }))
                  }
                />
              </div>
                ...
                saveOffer(
                  {
                    offerId:
                      editing?.offerId ||
                      `OFF-${String(allOffers.length + 1).padStart(3, "0")}`,
